...
#include <memory>
#include "../../8080_Emulator/src/emulator/emulator.h"
...
QT_MOC_LITERAL(1, 9, 15), // "screenIsUpdated"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 13), // "const QImage*"
QT_MOC_LITERAL(4, 40, 12), // "inputHandler"
QT_MOC_LITERAL(5, 53, 3), // "key"
QT_MOC_LITERAL(6, 57, 7), // "pressed"
QT_MOC_LITERAL(7, 65, 14), // "playSoundPort3"
QT_MOC_LITERAL(8, 80, 14) // "playSoundPort5"

    },
    "Emulator\0screenIsUpdated\0\0const QImage*\0"
    "inputHandler\0key\0pressed\0playSoundPort3\0"
    "playSoundPort5"
};
...
void Emulator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->screenIsUpdated((*reinterpret_cast< const QImage*(*)>(_a[1]))); break;
        case 1: _t->inputHandler((*reinterpret_cast< const int(*)>(_a[1])),(*reinterpret_cast< bool(*)>(_a[2]))); break;
        case 2: _t->playSoundPort3((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->playSoundPort5((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Emulator::*)(QImage const * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Emulator::screenIsUpdated)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Emulator::screenIsUpdated(QImage const * _t1)
{
